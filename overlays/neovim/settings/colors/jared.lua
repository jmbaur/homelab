...
hi("StatusLine", { bold = true, reverse = true, fg = xterm[251], bg = xterm[232] })
hi("StatusLineNC", { reverse = true, fg = xterm[251], bg = xterm[235] })
hi("TabLine", { fg = xterm[250], bg = xterm[235] })
hi("TabLineFill", { fg = xterm[235], bg = xterm[235] })
hi("TabLineSel", { fg = "fg", bg = xterm[235] })

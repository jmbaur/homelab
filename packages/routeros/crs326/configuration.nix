...
let
  ...
  configuration = {
    ...
    commands = [
      ...
      "/interface bridge port add bridge=bridge frame-types=admit-only-vlan-tagged interface=ether1"
      ...
      "/interface bridge port add bridge=bridge frame-types=admit-only-untagged-and-priority-tagged ingress-filtering=no interface=ether4 pvid=${toString inventory.networks.mgmt.id}"
      ...
      "/interface bridge port add bridge=bridge ingress-filtering=no interface=ether9"
      "/interface bridge port add bridge=bridge ingress-filtering=no interface=ether10"
      "/interface bridge port add bridge=bridge ingress-filtering=no interface=ether11"
      "/interface bridge port add bridge=bridge ingress-filtering=no interface=ether12"
      "/interface bridge port add bridge=bridge ingress-filtering=no interface=ether13"
      "/interface bridge port add bridge=bridge ingress-filtering=no interface=ether14"
      ...
      "/interface bridge port add bridge=bridge ingress-filtering=no interface=ether16"
      ...
      "/interface bridge port add bridge=bridge ingress-filtering=no interface=ether18"
      ...
      "/interface bridge port add bridge=bridge ingress-filtering=no interface=ether20"
      "/interface bridge port add bridge=bridge frame-types=admit-only-untagged-and-priority-tagged interface=ether21 pvid=${toString inventory.networks.wg-public.id}"
      "/interface bridge port add bridge=bridge ingress-filtering=no interface=ether22"
      ...
      "/interface bridge port add bridge=bridge ingress-filtering=no interface=ether24"
      ...
      "/interface bridge vlan add bridge=bridge tagged=ether1,bridge,sfp-sfpplus2 untagged=ether4,ether23 vlan-ids=${toString inventory.networks.mgmt.id}"
      "/interface bridge vlan add bridge=bridge untagged=ether21 vlan-ids=${toString inventory.networks.wg-public.id}"
      ...
      "/interface bridge vlan add bridge=bridge tagged=ether1,sfp-sfpplus2 untagged=ether15 vlan-ids=${toString inventory.networks.work.id}"

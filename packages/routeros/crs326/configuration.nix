...
let
  ...
  configuration = {
    ...
    commands = [
      ...
      "/interface bridge port add bridge=bridge frame-types=admit-only-untagged-and-priority-tagged interface=ether5 pvid=${toString inventory.networks.work.id}"
      ...
      "/interface bridge port add bridge=bridge disabled=yes ingress-filtering=no interface=ether10"
      ...
      "/interface bridge vlan add bridge=bridge tagged=ether1,bridge,sfp-sfpplus2 untagged=ether2,ether3,ether4,ether23 vlan-ids=${toString inventory.networks.mgmt.id}"
      ...
      "/interface bridge vlan add bridge=bridge tagged=ether1,sfp-sfpplus2 untagged=ether5,ether15 vlan-ids=${toString inventory.networks.work.id}"

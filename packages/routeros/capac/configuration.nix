...
let
  ...
  configuration = {
    ...
    commands = [
      ...
      "/ip address add address=${inventory.networks.mgmt.hosts.ap0.ipv4}/${toString inventory.networks.mgmt._ipv4Cidr} interface=${inventory.networks.mgmt.name} network=${inventory.networks.mgmt._networkIPv4}"

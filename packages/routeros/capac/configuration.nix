...
let
  ...
  configuration = {
    ...
    commands = [
      ...
      "/ip address add address=${inventory.networks.mgmt.hosts.ap0._computed._ipv4}/${toString inventory.networks.mgmt._computed._ipv4Cidr} interface=${inventory.networks.mgmt.name} network=${inventory.networks.mgmt._computed._networkIPv4}"
      ...
      "/ipv6 address add address=${inventory.networks.mgmt.hosts.ap0._computed._ipv6.ula} advertise=no interface=${inventory.networks.mgmt.name}"

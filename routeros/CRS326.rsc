# mar/12/2022 18:49:23 by RouterOS 6.49.4
...
add bridge=bridge frame-types=admit-only-untagged-and-priority-tagged ingress-filtering=yes interface=ether7 pvid=40
add bridge=bridge frame-types=admit-only-untagged-and-priority-tagged ingress-filtering=yes interface=ether8 pvid=50
...
add bridge=bridge tagged=sfp-sfpplus1 untagged=ether7 vlan-ids=40
add bridge=bridge tagged=sfp-sfpplus1,bridge untagged=ether1,ether2,ether3,ether4 vlan-ids=88
add bridge=bridge tagged=sfp-sfpplus1 untagged=ether5,ether6 vlan-ids=30
add bridge=bridge tagged=sfp-sfpplus1 untagged=ether8 vlan-ids=50
/ip address
